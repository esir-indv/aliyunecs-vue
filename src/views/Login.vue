        ...
        <div style="display: flex; background-color: white; width: 50%; border-radius: 5px; overflow: hidden">
            ...
            <div style="flex: 1; display: flex; align-items: center; justify-content: center">
                <el-form :model="user" style="width: 80%" :rules="rules" ref="loginRef">
                    <div style="font-size: 20px; font-weight: bold; text-align: center; margin-bottom: 20px">欢迎<span
                        id="Dlogin"  @mouseover="alertDlogin" @click="Dlogin">登录</span>三台农商信息系统
                    </div>
                    ...
                    <el-form-item prop="code">
                        <div style="display: flex">
                            <el-input placeholder="请输入验证码" prefix-icon="el-icon-circle-check" size="medium"
                    ...
                    <div style="display: flex">
                        ...
                        <div style="flex: 1; text-align: right">
                            <span style="color: #0f9876; cursor: pointer" @click="forgetpwd">忘记密码</span>
...
export default {
    ...
    methods: {
        ...
        forgetpwd() {
            this.$message.info("请联系电子科技部重置")
        },
        alertDlogin() {
            this.$message.info("点击直达,跳过登录")
        }
    }
}
</script>
